    ...
    <Article>
      ...
      <div class="text-left">
        <div class="mb-4">
          ...
          We followed a methodology for collecting social media data consolidated over the years. We focused on Twitter, which is well-known for providing access to publicly available messages upon specific requests through their application programming interface (API). We identified a set of hashtags and keywords gaining collective attention since the first recorded cases of COVID-19, namely: coronavirus, ncov, #Wuhan, covid19, covid-19, sarscov2, covid. This set includes the official name of the virus and the disease, including the early tentative ones, as well as the name of the city where the first cases of COVID-19 were recorded. We estimate the recall rate for these keywords to be higher than 16% and probably in the 40%-60% range at the time of recording.  We used the Filter API – to collect the data in real time, and aggregate the results daily. Our choice allowed us to monitor, without interruptions and regardless of the language, all the tweets posted about COVID19 since 22 January 2020, when China reported more than 6,000 cases, calling for the attention of the international community. The Stream API has the advantage of providing all the messages satisfying our selection criteria and posted to the platform in the period of observation, provided that their volume is not larger than 1% of the overall – unfiltered – volume of posted messages. Above 1% of the overall flow of information, the Filter API provides a sample of filtered tweets and communicates an estimate of the number of lost messages. Note that this choice is the most reliable to date: in fact, it was recently shown that biases affecting Sample API (which samples data based on rate limits), for instance, are not found in REST and Filter APIs.
          <br>
          We estimate that until 24 Feb 2020 we lost approximately 60,000 tweets out of millions, capturing more than 99.5% of all messages posted. The global attention towards COVID19 increased the volume of messages after 25 Feb 2020: however, Twitter restrictions allowed us to get no more than 4.5 million messages per day, on average. In total, we have collected between January and October 2020 more than billion tweets.
        </div>
        <div class="mb-4">
          <h3 class="pb-1">
            Geocoding
          ...
          The user’s self-declared location field was used for geocoding with ArcGIS API. For approximately 56% of users we had a response in terms of latitude and longitude. A large portion, about 10% of these answers were however associated with a small number (~1600) of wrongly attributed locations that were removed. These errors were mostly caused by the use of non-toponyms in the location field such as “Home” or “Somewhere”, or other pieces of information (Instagram, Website URLs, …), which were wrongly associated with real locations. We identified these errors by isolating single locations associated with a large number of different unique user-defined location strings. Finally, we also filtered out names of continents that were correctly geocoded but do not match the country-based granularity we set for our analysis. The reliability of our method was tested by comparing geocoded and georeferenced data for the USA.
        </div>
        <div class="mb-4">
          <h3 class="pb-1">
            Source Reliability Rating
          </h3>
          We collected manually checked web domains from multiple publicly available databases, including scientific and journalistic ones. Specifically, we considered data shared by the sources listed in:
          <ul>
            <li>
              Zimdar, M. My fake news list went viral but made up stories are only part of the problem. The Washington Post <a
                target="_blank"
              ...
              >https://www.washingtonpost.com/posteverything/wp/2016/11/18/my-fake-news-list-went-viral-but-made-up-stories-are-only-part-of-the-problem/</a> (18 November 2016).
            </li><li>
              Silverman, C. Inside the partisan fight for your news feed. BuzzFeed News <a
                target="_blank"
                href="https://www.buzzfeednews.com/article/craigsilverman/inside-the-partisan-fight-for-your-news-feed"
              >
                https://www.buzzfeednews.com/article/craigsilverman/inside-the-partisan-fight-for-your-news-feed</a> (8 August 2017).
            </li><li>
              Fake News Watch (2015); <a
                target="_blank"
                href="https://web.archive.org/web/20180213181029/http://www.fakenewswatch.com/"
              >https://web.archive.org/web/20180213181029/http://www.fakenewswatch.com/</a>
            </li><li>
              Politifacts guide to fake news and what they peddle. Politifacts.com <a
                target="_blank"
                href="https://www.politifact.com/article/2017/apr/20/politifacts-guide-fake-news-websites-and-what-they/"
              >https://www.politifact.com/article/2017/apr/20/politifacts-guide-fake-news-websites-and-what-they/</a> (20 April 2017).
            </li><li>
              The black list. La lista nera del web. Bufale.net <a
                target="_blank"
                href="https://www.bufale.net/the-black-list-la-lista-nera-del-web/"
              >https://www.bufale.net/the-black-list-la-lista-nera-del-web/</a> (2018).
            </li><li>
              ...
              Fletcher, R. et al. Measuring the Reach of ‘Fake News’ and Online Disinformation in Europe (Reuters Institute, 2018); <a
                target="_blank"
                href="https://reutersinstitute.politics.ox.ac.uk/our-research/measuring-reach-fake-news-and-online-disinformation-europe"
              >https://reutersinstitute.politics.ox.ac.uk/our-research/measuring-reach-fake-news-and-online-disinformation-europe</a>
            </li><li>
              Grinberg, N. et al. Fake news on Twitter during the 2016 US presidential election. Science 363, 374–378 (2019).
            </li><li>
              MediaBiasFactCheck (2020);
              <a
                target="_blank"
                href="https://mediabiasfactcheck.com"
              >
                https://mediabiasfactcheck.com</a>
            </li>
          </ul>
          <br>
          ...
          <br><br>
          A second level of filtering was applied to domains which are classified differently across databases (e.g., xyz.com might be classified as FAKE/HOAX in a database and as SATIRE in another database). To deal with these cases, we adopted our own classification method, by assigning to each category a “Harm Score” between 1 and 9. When two or more domains were soft duplicates, we kept the classification with the highest Harm Score, as a conservative choice. This phase of processing reduced the overall database to 3,920 unique domains.
          <br><br>
          The Harm Score classifies sources in terms of their potential contribution to the manipulative and mis-informative character of an infodemic. As a general principle, the more systematic and intentionally harmful the knowledge manipulation and data fabrication, the higher the Harm Score (HS). SCIENTIFIC content has the lowest level of HS due to the rigorous process of validation carried out through scientific methods. MAINSTREAM MEDIA content has the second lowest level of HS due to its constant scrutiny in terms of fact checking and media accountability. SATIRE is an unreliable source of news, but due to its explicit goal of distorting or mis-representing information according to specific cultural codes of humor and social critique, is generally identified with ease as an unreliable source. CLICKBAIT is a more dangerous source (and thus ranking higher in HS) due to its intent to pass fabricated or mis-represented information and facts for true, with the main purpose of attracting attention and online traffic, that is, for mostly commercial purposes, but without a clear ideological intent. OTHER is a general-purpose category that contains diverse forms of (possibly) misleading or fabricated content, not easily classifiable but likely including bits of ideologically characterized content pursuing systematic goals of social manipulation, and thus ranking higher in HS. SHADOW is a similar category to the previous one, where in addition links are anonymized and often temporary (e.g. bit.ly, dlvr.it,...) , thereby adding an extra element of unaccountability and manipulation that translates into a higher level of HS. Known vanity URL shorteners such usnyti.ms for the New York Times wpo.st for the Washington Post are automatically associated with the source. POLITICAL is a category where we find an ample spectrum of content with varying levels of distortion and manipulation of information, also including mere selective reporting and omission, whose goal is that of building consensus on a polarized political position against others, and therefore directly aiming at conditioning the public discourse and opinion making, with a comparatively higher level of HS with respect to the previous categories. The majority of web domains listed in this category overlaps with ‘left’ and ‘right’ categories as defined by the MediaBiasFactCheck source, while domains labelled as left-center and right-center are considered as MAINSTREAM MEDIA. FAKE/HOAX contains entirely manipulated or fabricated inflammatory content which is intended to be perceived as realistic and reliable and whose goal may also be political but fails to meet the basic rules of plausibility and accountability, thus reaching an even higher level of HS. Finally, the highest level of HS is associated to CONSPIRACY/JUNKSCI, that is, to strongly ideological, inflammatory content that aims at building conceptual paradigms that are entirely alternative and oppositional to tested and accountable knowledge and information, with the intent of building self-referential bubbles where fidelized audiences are simply refusing a priori any kind of knowledge or information that is not legitimized by the alternative source itself or by recognized affiliates, as it is typical in sects of religious or other nature.
          <br><br>
